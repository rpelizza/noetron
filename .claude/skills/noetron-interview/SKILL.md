...
- Planned edges, activated as each skill is born: `noetron-plan` (interview before design, stress after), `noetron-spec` (stress before execution), `noetron-execute` (gap mode is its mandatory stop).
